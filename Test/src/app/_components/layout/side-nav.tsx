...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/app/_components/layout/subnav-accordion";
        ...
        item.isChidren ? (
          ...
          <Link
            ...
            className={cn(
              ...
              path === item.href && "bg-muted font-bold hover:bg-muted text-sky-600 hover:text-sky-500"
            )}
          >
            <item.icon className={cn("h-5 w-5", path === item.href ? "text-sky-600 hover:text-sky-500" : item.color)} />
            <span
              className={cn(
                "absolute left-12 text-sm duration-200",
                !isOpen && className
